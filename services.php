                            ...
                            <dl>
                                ...
                                <dt>
                                    <div class="serv-price">
                                        <p>СТОИМОСТЬ</p>
                                        <p>при разрешении использовать фото для портфолио 1100 грн; конфиденциальной съемки 1600 грн</p>
                                    </div>
                                </dt>
                            </dl>
                        </div>
                        ...
                        <div class="serv-details">
                            <dl>
                                ...
                                <dt>
                                    <div class="serv-price">
                                        <p>СТОИМОСТЬ</p>
                                        <p>при разрешении использовать фото для портфолио 1900 грн;  конфиденциальной съемки 2400 грн</p>
                                    </div>
                                </dt>
                            </dl>
                        </div>
